...
public class Demo_QA {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("webdriver.chrome.driver", "src\\Browser_Driver\\chromedriver.exe ");
        ...
        driver.findElement(By.id("username")).sendKeys("riiii");

        driver.findElement(By.id("email_1")).sendKeys("raii127@gmail.com");
